...
function MovieComingSoon(props) {
    ...
    const lsMovieNow = props.homeState.lsHome.movieCommingSoon?.slice(0, 6)
...
export default connect(mapStateToProps, mapDispatchToProps)(MovieComingSoon)
